...
Located at the bottem right corner of the app window is the "Color Picker" button. This allows the user to personalize the text and window color of the application. :)
